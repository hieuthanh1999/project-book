...
class ProductSimilarity
{
    ...
    {
        // dd($productA);
        $featuresA = (object)(array(
                "weight" =>  (int)$productA['weight'],
                "author" => (int)$productA['author_id'],
                "publisher" => (int)$productA['publisher_id'],
                "page" =>(int) $productA['quantity_page'],
        ));
        $featuresB = (object)(array(
            "weight" =>  (int)$productB['weight'],
            "author" => (int)$productB['author_id'],
            "publisher" => (int)$productB['publisher_id'],
            "page" =>(int) $productB['quantity_page'],
        ));

        $productAFeatures = implode('', get_object_vars($featuresA));
        // dd($productAFeatures);
        $productBFeatures = implode('', get_object_vars($featuresB));
        ...
        return array_sum([
            ...
            (Similarity::jaccard((string)$productA['sub_category_id'], (string)$productB['sub_category_id']) * $this->categoryWeight)
