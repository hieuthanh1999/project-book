...
class Similarity
{
    public static function hamming(string $string1, string $string2, bool $returnDistance = false): float
    {
        ...
        //Hàm array_diff_assoc() trong PHP so sánh array1 với array2 và trả về các sự khác nhau.
    ...
    public static function jaccard(string $string1, string $string2, string $separator = ','): float
    {
        ...
        //Hàm array_intersect có giá trị truyền vào là n mảng, Trong đó mảng đầu tiên sẽ được so sánh với các mảng còn lại.
        // Kết quả trả về sẽ là một mảng chứa những phần tử ở mảng đầu tiên mà có VALUE tồn tại ở các bảng còn lại.
