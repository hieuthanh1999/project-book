...
(2, 'banner 2', 'bgparallax-07.jpg', 1, '2022-07-24 05:23:55', '2022-07-25 21:19:51');
...
(1, 'Sách trong nuớc', 'Sách trong nuớc', 1, '2022-07-24 05:24:51', '2022-07-24 05:24:51'),
(2, 'Sách nuớc ngoài', 'Sách nuớc ngoài', 1, '2022-07-24 05:25:05', '2022-07-24 05:25:05');
...
CREATE TABLE `table_orders` (
  ...
  `order_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'Đang xử lý đơn hàng',
...
INSERT INTO `table_product` (`id`, `code`, `sub_category_id`, `author_id`, `publisher_id`, `size_id`, `discount_id`, `name`, `short_description`, `long_description`, `quantity`, `price`, `image`, `quantity_page`, `status`, `weight`, `view_count`, `created_at`, `updated_at`) VALUES
(1, 'S001', 1, 1, 1, 1, NULL, 'Yêu đê', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 21, '120000', 'img-05.jpg', 232, 1, 1.30, 0, '2022-07-24 05:29:58', '2022-07-24 05:29:58'),
(2, 'S002', 2, 1, 1, 1, NULL, 'Yêu đê 2', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 21, '120000', 'img-01.jpg', 232, 1, 1.30, 0, '2022-07-24 05:30:19', '2022-07-24 05:30:19'),
(3, 'S002', 2, 1, 1, 1, NULL, 'Yêu đê 3', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 21, '120000', 'img-09.jpg', 232, 1, 1.30, 0, '2022-07-24 05:30:30', '2022-07-24 05:30:30');
...
(1, 'dev dev', 'n.hieuthanhps@gmail.com', NULL, '$2y$10$z0tb9TCgpKilGy.W/XlZuuNUjLuSM30UsgaAjRszclmwIEjo1Mbny', NULL, '2022-07-24 11:44:52', '2022-07-24 11:44:52', NULL, NULL, 0, 0, 0, NULL, NULL),
(2, 'dev dev', 'admin@gmail.com', NULL, '$2y$10$7VdSC4ZhQ.cqUlk8Z6RsWeyk/qMuYO6wlwEknm4q.Hg8NtHtelzCC', NULL, '2022-07-24 11:47:52', '2022-07-24 11:47:52', NULL, NULL, 2, 0, 0, NULL, NULL);
