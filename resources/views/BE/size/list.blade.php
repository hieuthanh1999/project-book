                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                            @if($value['status']>0)
                            <a href="/admin/size/disable_status/{{$value['id']}}"><span
                                    class="fa-thumb-styling-up fa fa-eye"></span></a>
                            @else
                            <a href="/admin/size/enable_status/{{$value['id']}}"><span
                                    class="fa-thumb-styling-down fa fa-eye-slash"></span></a>
                            @endif
                            </span></td>
                        <td><span class="text-ellipsis">{{$value['created_at']}}</span></td>
                        <td>
                            <a href="/admin/size/update/{{$value['id']}}" class="active x" ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active"></i>
                            </a>


                            <a onclick="return confirm('Xác nhận xóa?')" href="/admin/size/delete/{{$value['id']}}"
