                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @foreach($categorys as $category)
                                ...
                                <span class="text-ellipsis">{{$category['name']}}</span>
                                @endif
                            @endforeach
                        </td>
                        <td><span class="text-ellipsis">
                            @if($value['status']>0)
                            <a href="/admin/sub-category/disable_status/{{$value['id']}}"><span
                                    class="fa-thumb-styling-up fa fa-eye"></span></a>
                            @else
                            <a href="/admin/sub-category/enable_status/{{$value['id']}}"><span
