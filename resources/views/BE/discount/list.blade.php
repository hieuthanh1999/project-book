                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                            ...
                            @else
                            <a href="/admin/discount/enable_status/{{$value['id']}}"><span
                        ...
                        <td>
                            <a href="/admin/discount/update/{{$value['id']}}" class="active x" ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active"></i>
                            </a>


                            <a onclick="return confirm('Xác nhận xóa?')" href="/admin/discount/delete/{{$value['id']}}"
