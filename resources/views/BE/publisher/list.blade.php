                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                            @if($value['status']>0)
                            <a href="/admin/publisher/disable_status/{{$value['id']}}"><span
                                    class="fa-thumb-styling-up fa fa-eye"></span></a>
                            @else
                            <a href="/admin/publisher/enable_status/{{$value['id']}}"><span
                        ...
                        <td>
                            <a href="/admin/publisher/update/{{$value['id']}}" class="active x" ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active"></i>
                            </a>


                            <a onclick="return confirm('Xác nhận xóa?')" href="/admin/publisher/delete/{{$value['id']}}"
