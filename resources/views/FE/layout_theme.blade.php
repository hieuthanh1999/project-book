                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <strong class="tg-logo"><a href="index-2.html"><img
                                        src="{{URL::asset('FE/images/logo.png')}}" alt="company name here"></a></strong>
                                                    ...
                                                    <div class="tab-content tg-themetabcontent">
                                                        <div role="tabpanel" class="tab-pane active"
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <ul>
                                                                        <li><a href="products.html">Tough As Nails</a>
                                                                        </li>
                                                                        <li><a href="products.html">Pro Grease
                                                                                Monkey</a></li>
                                                                        <li><a href="products.html">Building
                                                                                Memories</a></li>
                                                                        <li><a href="products.html">Bulldozer Boyz</a>
                                                                        </li>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <ul>
                                                                        <li><a href="products.html">Veniam quis
                                                                                nostrud</a></li>
                                                                        <li><a href="products.html">Exercitation</a>
                                                                        </li>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <div class="tg-textbox">
                                                                        <h3>More Than<span>12,0657,53</span>Books
                                                                            Collection</h3>
                                                                        <div class="tg-description">
                                                                            <p>Consectetur adipisicing elit sed doe
                                                        ...
                                                        <div role="tabpanel" class="tab-pane" id="crimethriller">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <figure><img
                                                                            src="{{URL::asset('FE/images/img-01.png')}}"
                                                                            alt="image description"></figure>
                                                                    <div class="tg-textbox">
                                                                        <h3>More Than<span>12,0657,53</span>Books
                                                                            Collection</h3>
